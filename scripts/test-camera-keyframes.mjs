...
//     RECORD=1 로 재생성. 값 바뀌면 수식 변경을 의도했는지 확인 후 갱신.
{
  ...
  // ★정지 구간 도입 — 2026-08-01(사용자 지정: "25/75 로 나누니 뒷부분이 너무 짧다. 50/50 은?").
  //   push_in = zoom 12%/s · accel 1.5 · hold 0.5 → 앞 절반은 '완전히 정지'(1280 유지),
  //   뒤 절반에서 1178 → 864 로 들어간다. 지수 곡선만 쓰던 때처럼 끝 10% 에 몰리지 않는다.
  const GOLDEN = [
    [1280, 720, 0, 0],
    [1280, 720, 0, 0],
    [1280, 720, 0, 0],
