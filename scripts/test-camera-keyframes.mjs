...
//     RECORD=1 로 재생성. 값 바뀌면 수식 변경을 의도했는지 확인 후 갱신.
{
  ...
  // ★느린 구간 + 크립 — 2026-08-01(사용자 지정: "25/75 는 뒷부분이 짧다. 50/50", 그리고
  //   "완전히 정지는 아니다"). push_in = zoom 12%/s · accel 1.5 · hold 0.5 · creep 0.15 →
  //   앞 절반은 아주 느리게 기어가고(1280→1194, 86px), 뒤 절반에서 몰아친다(1194→864, 330px).
  // ★드리프트 0 으로 갱신 — 2026-08-02(사용자: "옆으로 이동해서 화면이 비뚤어진다").
  //   이제 x/y 가 정확히 중앙 유지: 끝 프레임 x=(1280-864)/2=208, y=(720-486)/2≈118.
  const GOLDEN = [
    [1280, 720, 0, 0],
    [1234, 694, 24, 14],
    [1194, 670, 44, 26],
