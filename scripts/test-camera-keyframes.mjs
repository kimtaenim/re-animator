...
//     RECORD=1 로 재생성. 값 바뀌면 수식 변경을 의도했는지 확인 후 갱신.
{
  ...
  // ★가속 줌 강화 — 2026-08-01(사용자 지정: "처음엔 거의 멈춰 있다가 갑자기 엄청난 속도로").
  //   push_in = zoom 12%/s · accel 4. 25% 지점 1280→1278(사실상 정지), 50% 1260, 75% 1148,
  //   끝 864 로 몰아친다 = 급가속이 실제로 걸려 있다는 수치 증거(이 값이 곧 회귀락).
  const GOLDEN = [
    [1280, 720, 0, 0],
    [1278, 718, 2, 0],
    [1260, 708, 12, 4],
