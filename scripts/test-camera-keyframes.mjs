...
//     RECORD=1 로 재생성. 값 바뀌면 수식 변경을 의도했는지 확인 후 갱신.
{
  ...
  // ★가속 줌(zoom_accel 1.6) 도입으로 갱신 — 2026-08-01(사용자 지정: "느리다가 갑자기
  //   빨라지는 가속도 줌이 중요"). 25% 지점이 1280→1268 로 거의 안 움직이고, 75%→1110,
  //   끝 968 로 급격해진다 = 가속이 실제로 걸려 있다는 수치 증거(이 값이 곧 회귀락).
  const GOLDEN = [
    [1280, 720, 0, 0],
    [1268, 712, 8, 4],
    [1214, 682, 40, 14],
