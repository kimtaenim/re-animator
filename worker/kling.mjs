...
// ★720p — 1080p 로 올렸다가 워커 OOM 이 반복됐다(ffmpeg 디코딩·인코딩 메모리 2배).
//   게다가 낭비였다: targetDims 가 16:9=1280x720 / 9:16=720x1280 이라 어떤 경우든 720p 급으로
//   줄여서 내보낸다 → 1080p 로 받아도 최종물에 남지 않는다. 비용만 내고 버리던 셈.
//   1080p 출력이 실제로 필요해지면 targetDims 와 함께 올려야 한다.
