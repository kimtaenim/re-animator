...
const PROMPT =
  ...
  "sfx = ★효과음/의성어 글자★(말풍선 밖에 크게 그려진 소리 글자 — 쾅, 퍽, 우당탕, 콰앙, ドン, ズガン, 부르르, 두근두근 등). " +
  "있으면 그대로, 없으면 빈 문자열. ★★효과음은 절대 bubbles 에 넣지 마라 — bubbles 는 '사람이 말하는 대사·내레이션'만이다. " +
  "말풍선 테두리가 없고 그림 위에 크게 흩어져 그려진 소리 글자는 전부 sfx 다. 여러 개면 공백으로 이어라.★★ " +
