...
const PROMPT =
  ...
  "bubbles = 말풍선/대사/자막을 ★말풍선(글상자) 단위로 하나씩★ 배열로. 각 항목: text(그 풍선 글자를 ★내용은 보이는 그대로 정확히★ — 빠뜨리거나 지어내지 마라, 확실히 안 읽히면 빈 문자열. ★단 띄어쓰기만 표준 한국어 맞춤법에 맞게 자연스럽게 정리★해서. 세로쓰기·줄바꿈은 한 줄로 이어라)와 그 풍선 영역 박스(left,top,right,bottom, 이미지 대비 0~1). 서로 다른 인물의 말풍선은 반드시 다른 항목으로 나눠라. 글자 없으면 빈 배열. " +
